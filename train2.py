...
from Model2 import get_custom_model  # Change import statement
...
if __name__ == "__main__":
    ...
    model = get_custom_model()  # Change to use Model2.py function
    ...
    callbacks += [ModelCheckpoint('./backup_model_last2.hdf5'),
                  ModelCheckpoint('./backup_model_best2.hdf5', save_best_only=True)]
    ...
    # Save final result
    model.save("./final_model2.hdf5")  # Change the filename to reflect Model2.py

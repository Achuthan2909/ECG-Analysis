...
# %% Read datasets
# Get two annotators
y_cardiologist1 = pd.read_csv('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/data/annotations/cardiologist1.csv').values
y_cardiologist2 = pd.read_csv('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/data/annotations/cardiologist2.csv').values
# Get true values
y_true = pd.read_csv('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/data/annotations/gold_standard.csv').values
# Get residents and students performance
y_cardio = pd.read_csv('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/data/annotations/cardiology_residents.csv').values
y_emerg = pd.read_csv('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/data/annotations/emergency_residents.csv').values
y_student = pd.read_csv('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/data/annotations/medical_students.csv').values
# get y_score for different models
y_score_list = [np.load("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/dnn_predicts/other_seeds/model_"+str(i)+".npy")for i in range(10)]
...
# Save results
scores_all_df.to_excel("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/scores.xlsx", float_format='%.3f')
scores_all_df.to_csv("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/scores.csv", float_format='%.3f')
...
for k, name in enumerate(diagnosis):
    ...
    if k == 0:
        ...
        ax.legend().remove()
    plt.tight_layout()
    plt.savefig('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/figures/precision_recall_{0}.pdf'.format(name))
...
confusion_matrices.to_excel("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/confusion matrices.xlsx", float_format='%.3f')
confusion_matrices.to_csv("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/confusion matrices.csv", float_format='%.3f')
...
for sf in score_fun:
    ...
    if sf == "F1 score":
        ...
        ax.legend().remove()
    plt.tight_layout()
    plt.savefig('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/figures/boxplot_bootstrap_{}.pdf'.format(sf))


scores_resampled_xr.to_dataframe(name='score').to_csv('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/figures/boxplot_bootstrap_data.txt')
...
# Save results
mcnemar.to_excel("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/mcnemar.xlsx", float_format='%.3f')
mcnemar.to_csv("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/mcnemar.csv", float_format='%.3f')
...
# Save results
kappa.to_excel("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/kappa.xlsx", float_format='%.3f')
kappa.to_csv("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/kappa.csv", float_format='%.3f')
...
kappas_annotators_and_DNN.to_excel("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/kappas_annotators_and_DNN.xlsx", float_format='%.3f')
kappas_annotators_and_DNN.to_csv("C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/tables/kappas_annotators_and_DNN.csv", float_format='%.3f')
...
plt.xlim([-0.5, 5.5])
plt.tight_layout()
plt.savefig('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/figures/boxplot_bootstrap_other_splits_{0}.pdf'.format(sf))
f1_score_resampled_df.to_csv('C:/Users/Admin/Desktop/GithubWork/ECG-Analysis/outputs/figures/boxplot_bootstrap_other_splits_data.txt', index=False)